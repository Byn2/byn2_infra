...
export default function EditInvoicePage() {
  ...
  useEffect(() => {
    const fetchInvoiceDetails = async () => {
      ...
      try {
        ...
        const { count, isRecurring } = invoice.installments || {}
        const { name, address, email, phone } = invoice.recipientDetails || {}
        const { subtotal, tax, total } = invoice.amount || {}
        ...
        setInstallmentCount(count || 1)
        setIsRecurring(isRecurring || false)
        setNotes(invoice.notes || "")
        setStatus(invoice.status || "")
        setCurrency(invoice.currency || "SL")

        // Calculate tax rate if subtotal and tax are available
        if (subtotal && tax) {
          const calculatedTaxRate = (tax / subtotal) * 100
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast("Error", {
        description: (error as Error).message || "Failed to update invoice",
      })
    } finally {
      setIsSaving(false)
    }
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="rounded-lg border bg-white p-6">
              <div className="mb-4">
                <Label className="mb-2" htmlFor="invoice-number">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label className="mb-2" htmlFor="recipient-name">
                      Name
                    </Label>
                    <Input
                      id="recipient-name"
                  ...
                  <div>
                    <Label className="mb-2" htmlFor="recipient-address">
                      Address
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label className="mb-2" htmlFor="recipient-email">
                      Email
                    </Label>
                    <Input
                      id="recipient-email"
                  ...
                  <div>
                    <Label className="mb-2" htmlFor="recipient-phone">
                      Phone
                    </Label>
                    <Input
                      id="recipient-phone"
                ...
                <div>
                  <Label className="mb-2" htmlFor="invoice-description">
                    Invoice Description
                  </Label>
                  <Input
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label className="mb-2" htmlFor="issued-date">
                      Issued on
                    </Label>
                  ...
                  <div>
                    <Label className="mb-2" htmlFor="due-date">
                      Due on
                    </Label>
                    <div className="relative">
                      <Input
                ...
                <div className="flex items-center space-x-4">
                  <div>
                    <Label className="mb-2" htmlFor="installment-count">
          ...
          <div className="rounded-lg border bg-[#FAF7F2] p-6">
            ...
            <div className="mt-6 flex justify-end space-x-4">
              <Link href={`/dashboard/invoices/${invoiceId}`}>
                <Button type="button" variant="outline" className="border-[#66432E] text-[#66432E]">
                  Cancel
                </Button>
              </Link>
              <Button type="submit" disabled={isSaving} className="bg-[#66432E] hover:bg-[#523526]">
