...
export async function mmDepositMessageTemplateConfirm(name: string, mobile: string, depositing_number: any, amount: any){
  return {
    header: {
...
export async function mmDepositMessageTemplateUSSDDifferentNumber(name: string, mobile: string, intent: any){
  return {
    header: {
...
//check balance
export async function checkBalanceMessageTemplate(name: string, mobile: string, usdc: number, fiat: number) {
